...
wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyAzDfAuzZjQb8mjKBlpOOCEqXE2WXPR-wY', NULL, '1.0', true);
...
wp_localize_script('main-college-js', 'collegeData', array(
...
$api['key'] = 'AIzaSyAzDfAuzZjQb8mjKBlpOOCEqXE2WXPR-wY';
  return $api;
}
