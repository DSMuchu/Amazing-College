...
var Search = function () {
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery2.default.getJSON(collegeData.root_url + '/wp-json/college/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join('') + "\n          " + (results.generalInfo.length ? '</ul>' : '') + "\n        </div>\n        <div class=\"one-third\">\n          <h2 class=\"search-overlay__section-title\">Programs</h2>\n          " + (results.programs.length ? '<ul class="link-list min-list">' : "<p>No Program matches that search.<a href=\"" + collegeData.root_url + "/programs\">View All Programs</a></p>") + "\n          " + results.programs.map(function (item) {
